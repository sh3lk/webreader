...
func ID(id ulid.ID) predicate.Category {
...
func IDEQ(id ulid.ID) predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id ulid.ID) predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
...
func IDIn(ids ...ulid.ID) predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
		v := make([]any, len(ids))
		for i := range v {
			v[i] = ids[i]
...
func IDNotIn(ids ...ulid.ID) predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
		v := make([]any, len(ids))
		for i := range v {
			v[i] = ids[i]
...
func IDGT(id ulid.ID) predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
...
func IDGTE(id ulid.ID) predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
...
func IDLT(id ulid.ID) predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
...
func IDLTE(id ulid.ID) predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
...
// HasRanobes applies the HasEdge predicate on the "ranobes" edge.
func HasRanobes() predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(RanobesTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, RanobesTable, RanobesPrimaryKey...),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasRanobesWith applies the HasEdge predicate on the "ranobes" edge with a given conditions (other predicates).
func HasRanobesWith(preds ...predicate.Ranobe) predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(RanobesInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, RanobesTable, RanobesPrimaryKey...),
		)
