...
func (cc *CategoryCreate) SetID(u ulid.ID) *CategoryCreate {
	cc.mutation.SetID(u)
	return cc
}

// SetNillableID sets the "id" field if the given value is not nil.
func (cc *CategoryCreate) SetNillableID(u *ulid.ID) *CategoryCreate {
	if u != nil {
		cc.SetID(*u)
	}
	return cc
...
func (cc *CategoryCreate) AddRanobeIDs(ids ...ulid.ID) *CategoryCreate {
	cc.mutation.AddRanobeIDs(ids...)
	return cc
}

// AddRanobes adds the "ranobes" edges to the Ranobe entity.
func (cc *CategoryCreate) AddRanobes(r ...*Ranobe) *CategoryCreate {
	ids := make([]ulid.ID, len(r))
	for i := range r {
		ids[i] = r[i].ID
	}
	return cc.AddRanobeIDs(ids...)
}
...
func (cc *CategoryCreate) createSpec() (*Category, *sqlgraph.CreateSpec) {
	...
	if nodes := cc.mutation.RanobesIDs(); len(nodes) > 0 {
