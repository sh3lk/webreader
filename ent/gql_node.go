...
func (r *Ranobe) Node(ctx context.Context) (node *Node, err error) {
	node = &Node{
		ID:     r.ID,
		Type:   "Ranobe",
		Fields: make([]*Field, 7),
	...
	if buf, err = json.Marshal(r.EngName); err != nil {
		return nil, err
	}
	node.Fields[3] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(r.RusName); err != nil {
		return nil, err
	}
	node.Fields[4] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(r.Summary); err != nil {
		return nil, err
	}
	node.Fields[5] = &Field{
		Type:  "string",
